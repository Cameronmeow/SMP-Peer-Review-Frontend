      ...
      if (data.success) {
        toast.success(`Login successful: \n${data.details.fullname}`, {
          ...
          onClose: () => {
            ...
            localStorage.setItem("reviewedApplicants",JSON.stringify(data.details.reviewedApplicants));
...
return(
    ...
    <div style={{backgroundColor: "#142749" , fontFamily: "Tilt Neon, sans-serif", fontWeight: "100", fontStyle: "normal"}}>
