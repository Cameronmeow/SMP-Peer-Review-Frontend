  ...
  function Recommendations() {
    ...
    return (
      <>
        ...
        />
        <div
          className="container css-selector w-100"
          style={{
        ...
        <div className="container my-4">
          ...
          />
          <label htmlFor="declaration" className="ms-2">
            I hereby declare that I have completed this peer review form for all individuals I know as listed on the recommendations page. I affirm that I have provided honest, fair, and accurate reviews to the best of my knowledge and ability. I confirm that I have not engaged in any misconduct, falsified information, or provided misleading responses during this review process<br/>I understand that any false statements, misrepresentations, or misconduct may result in appropriate actions as per the policies of SMP, including the potential rejection of my ISMP application.
          </label>
        </div>
